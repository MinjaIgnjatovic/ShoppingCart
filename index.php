        ...
        <div class='container' style='width:800px;'>
            ...
            <div class='tab-content'>
                ...
                <div class='col-md-4' style="margin-top:12px;">
                    <div style="border:1px solid #333;border-radius:5px; background-color:#f1f1f1; padding:16px; heigt:350px;" align="center">
                        ...
                        <input type='button' name='add_to_cart' id='<?php echo $row['id']; ?>' class="btn btn-warning form-control add_to_cart" value='Add to Cart' />
                    </div>
                </div>
                <?php
                }
                        ...
                        <table class='table table-bordered'>
                            ...
                            if(!empty($_SESSION['shopping_cart']))
                            {
                             ...
                             <tr>
                                    ...
                                    <td><input type="text" name="quantity[]" id="quantity<?php echo $values['product_id']; ?>" value="<?php echo $values['product_quantity']; ?>" data-product_id="<?php echo $values["product_id"]; ?>" class="quantity" /></td>
            ...
            var action='add';
             if(product_quantity>0)
             {
                $.ajax({
                    ...
                    success:function(data)//dobija info od servera i skladisti u prom data
                    {
